...
const storeId = companyId.Gazaoua;

export const gazaouaStore = defineStore(storeId, () => {
    const gazaoua = ref(initializeStation(companyId.Gazaoua));
    ...
    const company = computed(() => gazaoua.value)
    console.log("GazouaStore", company.value);
