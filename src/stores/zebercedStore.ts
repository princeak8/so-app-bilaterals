...
const storeId = companyId.Zeberced;

export const zebercedStore = defineStore(storeId, () => {
    const zeberced = ref(initializeStation(companyId.Zeberced));
    ...
    const company = computed(() => zeberced.value)
