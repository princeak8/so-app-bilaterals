...
const storeId = companyId.InnerGalaxy1;

export const innerGalaxy1Store = defineStore(storeId, () => {
    const innerGalaxy1 = ref(initializeStation(companyId.InnerGalaxy1));
    ...
    function set (data: stationType) {
        // console.log('InnerGalaxy1:', data);
        innerGalaxy1.value = {...data};
    ...
    const company = computed(() => innerGalaxy1.value)
