...
const storeId = companyId.Niamey;

export const niameyStore = defineStore(storeId, () => {
    const niamey = ref(initializeStation(companyId.Niamey));
    ...
    const company = computed(() => niamey.value)
