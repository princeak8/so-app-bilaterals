...
const storeId = companyId.StarPipe;

export const starPipeStore = defineStore(storeId, () => {
    const starPipe = ref(initializeStation(companyId.StarPipe));
    ...
    const company = computed(() => starPipe.value)
