...
const storeId = companyId.PSML;

export const psmlStore = defineStore(storeId, () => {
    const psml = ref(initializeStation(companyId.PSML));
    ...
    const company = computed(() => psml.value)
