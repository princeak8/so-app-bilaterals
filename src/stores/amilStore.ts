...
const storeId = companyId.AMIL;

export const amilStore = defineStore(storeId, () => {
    const amil = ref(initializeStation(companyId.AMIL));
    const storeId = companyId.AMIL;
    ...
    const company = computed(() => amil.value)
