...
const storeId = companyId.AENL;

export const aenlStore = defineStore(storeId, () => {
    const aenl = ref(initializeStation(companyId.AENL));
    const storeId = companyId.AENL;
    ...
    const company = computed(() => aenl.value)
    // console.log("Amil company:", company.value);
