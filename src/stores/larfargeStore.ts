...
const storeId = companyId.Larfarge;

export const larfargeStore = defineStore(storeId, () => {
    const larfarge = ref(initializeStation(companyId.Larfarge));
    ...
    const company = computed(() => larfarge.value)
