...
const storeId = companyId.ErKang;
export const erKangStore = defineStore(storeId, () => {
    const erKang = ref(initializeStation(companyId.ErKang));
    ...
    const company = computed(() => erKang.value)
