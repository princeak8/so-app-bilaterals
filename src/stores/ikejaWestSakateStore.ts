...
const storeId = companyId.IkejaWestSakate;

export const ikejaWestSakateStore = defineStore(storeId, () => {
    const ikejaWestSakate = ref(initializeStation(companyId.IkejaWestSakate));
    const storeId = companyId.IkejaWestSakate;
    ...
    const company = computed(() => ikejaWestSakate.value)
    // console.log("IkejaWestSakate company:", company.value);
