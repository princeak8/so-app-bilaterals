...
const storeId = companyId.ATVL;

export const atvlStore = defineStore(storeId, () => {
    const atvl = ref(initializeStation(companyId.ATVL));
    ...
    const company = computed(() => atvl.value)
