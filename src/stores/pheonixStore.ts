...
const storeId = companyId.Pheonix;

export const pheonixStore = defineStore(storeId, () => {
    const pheonix = ref(initializeStation(companyId.Pheonix));
    ...
    const company = computed(() => pheonix.value)
