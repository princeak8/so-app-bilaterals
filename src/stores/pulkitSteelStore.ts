...
const storeId = companyId.PulkitSteel;

export const pulkitSteelStore = defineStore(storeId, () => {
    const pulkitSteel = ref(initializeStation(companyId.PulkitSteel));
    ...
    const company = computed(() => pulkitSteel.value)
