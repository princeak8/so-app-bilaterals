...
const storeId = companyId.Quantum;

export const quantumStore = defineStore(storeId, () => {
    const quantum = ref(initializeStation(companyId.Quantum));
    ...
    const company = computed(() => quantum.value)
