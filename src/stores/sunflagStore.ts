...
const storeId = companyId.Sunflag;

export const sunflagStore = defineStore(storeId, () => {
    const sunflag = ref(initializeStation(companyId.Sunflag));
    ...
    const company = computed(() => sunflag.value)
