...
const storeId = companyId.OAU_Ife;
export const oauIfeStore = defineStore(storeId, () => {
    const oauIfe = ref(initializeStation(companyId.OAU_Ife));
    ...
    const company = computed(() => oauIfe.value)
